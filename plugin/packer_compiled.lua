...
_G.packer_plugins = {
  ...
  ["gruvbox.nvim"] = {
    ...
    config = { "\27LJ\2\nJ\0\0\3\0\3\0\0056\0\0\0009\0\1\0'\2\2\0B\0\2\1K\0\1\0+          colorscheme gruvbox\n        \bcmd\bvim\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = true,
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'emmet-vim', 'vim-table-mode', 'markdown-preview.nvim', 'vista.vim', 'glow.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
vim.cmd [[au FileType svelte ++once lua require("packer.load")({'nvim-ts-autotag'}, { ft = "svelte" }, _G.packer_plugins)]]
vim.cmd [[au FileType html ++once lua require("packer.load")({'emmet-vim', 'nvim-ts-autotag', 'tagalong.vim'}, { ft = "html" }, _G.packer_plugins)]]
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'smartim', 'neogen'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'Comment.nvim', 'todo-comments.nvim', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
