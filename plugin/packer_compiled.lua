...
_G.packer_plugins = {
  ...
  ["ftFT.nvim"] = {
    ...
    loaded = true,
    path = "/Users/macos/.local/share/lunarvim/site/pack/packer/start/ftFT.nvim"
  },
  ["gitsigns.nvim"] = {
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'markdown-preview.nvim', 'vim-table-mode', 'vista.vim', 'emmet-vim', 'glow.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'todo-comments.nvim', 'lsp_signature.nvim', 'indent-blankline.nvim', 'Comment.nvim', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
