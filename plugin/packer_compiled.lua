...
_G.packer_plugins = {
  ...
  ZFVimIM_xiaohe = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/Users/macos/.local/share/lunarvim/site/pack/packer/opt/ZFVimIM_xiaohe"
  },
  ZFVimJob = {
    loaded = false,
    needs_bufread = false,
  ...
  ["symbols-outline.nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/Users/macos/.local/share/lunarvim/site/pack/packer/opt/symbols-outline.nvim"
  },
  ["telescope.nvim"] = {
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vista.vim', 'glow.nvim', 'markdown-preview.nvim', 'vim-table-mode', 'emmet-vim'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-colorizer.lua', 'nvim-comment', 'todo-comments.nvim', 'gitsigns.nvim', 'lsp_signature.nvim', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'neogen', 'ZFVimJob', 'ZFVimIM', 'smartim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
