...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'emmet-vim', 'glow.nvim', 'vim-table-mode', 'vista.vim', 'markdown-preview.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
