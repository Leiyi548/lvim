...
_G.packer_plugins = {
  ...
  ["gruvbox.nvim"] = {
    ...
    config = { "\27LJ\2\ny\0\0\3\0\3\0\0056\0\0\0009\0\1\0'\2\2\0B\0\2\1K\0\1\0Z          colorscheme gruvbox\n          let g:gruvbox_italicize_comments = 0\n        \bcmd\bvim\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = true,
  ...
  neogen = {
    config = { "\27LJ\2\nS\0\0\3\0\4\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0B\0\2\1K\0\1\0\1\0\2\rjump_map\n<C-,>\fenabled\2\nsetup\vneogen\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["neoscroll.nvim"] = {
    config = { "\27LJ\2\nÕ\1\0\0\4\0\6\0\t6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\4\0005\3\3\0=\3\5\2B\0\2\1K\0\1\0\rmappings\1\0\5\16hide_cursor\2\24use_local_scrolloff\1\rstop_eof\2\25cursor_scrolls_alone\2\22respect_scrolloff\1\1\n\0\0\n<C-u>\n<C-d>\n<C-b>\n<C-f>\n<C-y>\n<C-e>\azt\azz\azb\nsetup\14neoscroll\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  rnvimr = {
    ...
    config = { "\27LJ\2\n¼\1\0\0\6\0\n\0\0176\0\0\0009\0\1\0)\1\1\0=\1\2\0006\0\0\0009\0\1\0)\1\1\0=\1\3\0006\0\0\0009\0\4\0009\0\5\0'\2\6\0'\3\a\0'\4\b\0005\5\t\0B\0\5\1K\0\1\0\1\0\2\fnoremap\2\vsilent\2\22:RnvimrToggle<CR>\15<leader>tr\6n\20nvim_set_keymap\bapi\21rnvimr_bw_enable\23rnvimr_draw_border\6g\bvim\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["telescope-emoji.nvim"] = {
    loaded = true,
    path = "/Users/macos/.local/share/lunarvim/site/pack/packer/start/telescope-emoji.nvim",
...
vim.cmd [[au FileType org ++once lua require("packer.load")({'orgmode.nvim', 'headlines.nvim', 'org-bullets.nvim'}, { ft = "org" }, _G.packer_plugins)]]
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'emmet-vim', 'glow.nvim', 'markdown-preview.nvim', 'vim-table-mode', 'vista.vim'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType html ++once lua require("packer.load")({'emmet-vim', 'tagalong.vim', 'nvim-ts-autotag'}, { ft = "html" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType java ++once lua require("packer.load")({'vista.vim', 'neogen'}, { ft = "java" }, _G.packer_plugins)]]
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'cmp-tabnine', 'smartim', 'neogen'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'Comment.nvim', 'indent-blankline.nvim', 'todo-comments.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au WinScrolled * ++once lua require("packer.load")({'neoscroll.nvim'}, { event = "WinScrolled *" }, _G.packer_plugins)]]
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'which-key.nvim', 'toggleterm.nvim', 'barbar.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
