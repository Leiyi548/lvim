...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'glow.nvim', 'vim-table-mode', 'vista.vim', 'markdown-preview.nvim', 'emmet-vim'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'indent-blankline.nvim', 'lsp_signature.nvim', 'nvim-colorizer.lua', 'todo-comments.nvim', 'Comment.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
