...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vista.vim', 'emmet-vim', 'vim-table-mode', 'glow.nvim', 'markdown-preview.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
