...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'emmet-vim', 'markdown-preview.nvim', 'glow.nvim', 'vim-table-mode', 'vista.vim'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'Comment.nvim', 'indent-blankline.nvim', 'todo-comments.nvim', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
