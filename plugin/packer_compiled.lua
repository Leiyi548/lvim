...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'emmet-vim', 'vim-table-mode', 'glow.nvim', 'vista.vim', 'markdown-preview.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
