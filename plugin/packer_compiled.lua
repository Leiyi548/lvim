...
vim.cmd [[au FileType org ++once lua require("packer.load")({'headlines.nvim', 'orgmode.nvim', 'org-bullets.nvim'}, { ft = "org" }, _G.packer_plugins)]]
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'markdown-preview.nvim', 'vim-table-mode', 'emmet-vim', 'vista.vim', 'glow.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'lsp_signature.nvim', 'nvim-colorizer.lua', 'todo-comments.nvim', 'Comment.nvim', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
