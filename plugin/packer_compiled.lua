...
_G.packer_plugins = {
  ...
  ["vscode.nvim"] = {
    ...
    loaded = true,
    path = "/Users/macos/.local/share/lunarvim/site/pack/packer/start/vscode.nvim",
...
try_loadstring("\27LJ\2\n4\0\0\2\0\4\0\0056\0\0\0009\0\1\0'\1\3\0=\1\2\0K\0\1\0\nlight\17vscode_style\6g\bvim\0", "config", "vscode.nvim")
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'emmet-vim', 'markdown-preview.nvim', 'vim-table-mode', 'vista.vim', 'glow.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'neogen', 'cmp-tabnine', 'smartim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
