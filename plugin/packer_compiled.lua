...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'emmet-vim', 'glow.nvim', 'markdown-preview.nvim', 'vista.vim', 'vim-table-mode'}, { ft = "markdown" }, _G.packer_plugins)]]
