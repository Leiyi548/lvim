...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'glow.nvim', 'emmet-vim', 'markdown-preview.nvim', 'vim-table-mode', 'vista.vim'}, { ft = "markdown" }, _G.packer_plugins)]]
