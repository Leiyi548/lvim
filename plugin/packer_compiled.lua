...
_G.packer_plugins = {
  ...
  ["cmp-under-comparator"] = {
    config = { "\27LJ\2\n3\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\24user.cmp-comparator\frequire\0" },
    loaded = true,
...
-- Config for: cmp-under-comparator
time([[Config for cmp-under-comparator]], true)
try_loadstring("\27LJ\2\n3\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\24user.cmp-comparator\frequire\0", "config", "cmp-under-comparator")
time([[Config for cmp-under-comparator]], false)
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'glow.nvim', 'headlines.nvim', 'markdown-preview.nvim', 'vim-table-mode', 'vista.vim', 'emmet-vim'}, { ft = "markdown" }, _G.packer_plugins)]]
